...
class HTTPPusherTests(HomeserverTestCase):
    ...
    def test_sends_high_priority_for_encrypted(self):
        ...
        '''
        # watcha+
        self.assertEqual(self.push_attempts[0][1], "http://127.0.0.1:5000/_matrix/push/v1/notify")
        # +watcha
        ...
        # watcha+
        self.helper.invite(room, user_id, yet_another_user_id, tok=access_token)
        # +watcha
        self.helper.join(
        ...
        '''
        # watcha+
        self.assertEqual(self.push_attempts[1][1], "http://127.0.0.1:5000/_matrix/push/v1/notify")
        # +watcha
    ...
    def test_sends_high_priority_for_atroom(self):
        ...
        # The other users join
        # watcha +
        self.helper.invite (room, other_user_id, user_id, tok=other_access_token)
        # + watcha
