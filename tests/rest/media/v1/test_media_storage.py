...
class MediaRepoTests(unittest.HomeserverTestCase):
    ...
    def test_disposition_filename_ascii(self):
        ...
        self.assertEqual(
            headers.getRawHeaders(b"Content-Disposition"), [b"attachment; filename=out.png"] # modified by watcha: inline -> attachment
        )
    ...
    def test_disposition_filenamestar_utf8escaped(self):
        ...
        self.assertEqual(
            ...
            [b"attachment; filename*=utf-8''" + filename + b".png"],  # modified by watcha: inline -> attachment
        )
