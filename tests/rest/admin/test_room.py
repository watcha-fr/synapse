...
class RoomTestCase(unittest.HomeserverTestCase):
    ...
    def test_correct_room_attributes(self):
        ...
        # watcha+
        self.helper.invite(room_id, self.admin_user, user_2, tok=self.admin_user_tok)
        # +watcha
    ...
    def test_room_list_sort_order(self):
        ...
        # watcha+
        self.helper.invite(room_id_2, self.admin_user, user_1, tok=self.admin_user_tok)
        # +watcha
        ...
        # watcha+
        self.helper.invite(room_id_3, self.admin_user, user_2, tok=self.admin_user_tok)
        # +watcha
        ...
        # watcha+
        self.helper.invite(room_id_3, self.admin_user, user_3, tok=self.admin_user_tok)
        # +watcha
    ...
    def test_room_members(self):
        ...
        # watcha+
        self.helper.invite(room_id_1, self.admin_user, user_1, tok=self.admin_user_tok)
        # +watcha
        ...
        # watcha+
        self.helper.invite(room_id_2, self.admin_user, user_3, tok=self.admin_user_tok)
        # +watcha
