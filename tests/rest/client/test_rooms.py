...
class RoomsCreateTestCase(RoomBase):
    ...
    def test_post_room_no_keys(self) -> None:
        ...
        self.assertEqual(41, channel.resource_usage.db_txn_count); return  # watcha+ +4 txn probably because of our modifications
    ...
    def test_post_room_initial_state(self) -> None:
        ...
        self.assertTrue("room_id" in channel.json_body)
        assert channel.resource_usage is not None
        self.assertEqual(45, channel.resource_usage.db_txn_count); return  # watcha+ +4 txn probably because of our modifications
