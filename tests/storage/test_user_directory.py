...
class WatchaUserDirectoryStoreTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        yield self.store.register_user(self.user_id, password_hash=None, create_profile_with_displayname=None)

        #Register an active user who @user:test want to see :
        yield self.store.register_user(self.searched_user, password_hash=None, create_profile_with_displayname=None)

        #Register an active external partner :
        yield self.store.register_user(self.partner_id, password_hash=None, make_partner=True, create_profile_with_displayname=None)
