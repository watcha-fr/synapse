...
class WatchaRoomEventsStoreTestCase(unittest.TestCase):
    ...
    def test_send_room_mapping_event_without_nextcloud_content(self):
        with self.assertRaises(SynapseError) as e:
            ...
            self.assertEquals(
                e.exception.msg, "The nextcloud url is needed to store room link with NC."
            )
    ...
    def test_set_same_NC_directory_path(self):
        ...
        self.assertEquals(e.exception.msg, "This Nextcloud folder is already linked with another room.")
