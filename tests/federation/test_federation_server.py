...
class StateQueryTests(unittest.FederatingHomeserverTestCase):
    ...
    test_without_event_id.skip = "Disabled for Watcha because private visibility of room scuttle the test. We have to find another way to force private visibility of rooms."
