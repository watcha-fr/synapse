...
class WatchaAdminStore(SQLBaseStore):
    ...
    async def _get_new_rooms(self):
        ...
        return await self.db.runInteraction("_get_new_rooms", _get_new_rooms_txn)
    ...
    async def _get_active_rooms(self):
        ...
        return await self.db.runInteraction("_get_active_rooms", _get_active_rooms_txn)
    ...
    async def _get_dm_rooms(self):
        ...
        dm_rooms_by_member = await self.db.simple_select_onecol(
            table="account_data",
    ...
    async def _get_users_stats(self):
        ...
        users = await self.db.runInteraction("_get_users_stats", _get_users_stats_txn)
    ...
    async def watcha_email_list(self):
        ...
        return await self.db.runInteraction("watcha_email_list", watcha_email_list_txn)
    ...
    async def watcha_user_ip(self, user_id):
        ...
        return await self.db.runInteraction("watcha_user_ip", watcha_user_ip_txn)
    ...
    async def members_by_room(self):
        ...
        room_memberships = await self.db.runInteraction(
    ...
    async def watcha_room_membership(self):
        return await self.db.simple_select_list(
    ...
    async def _update_user(self, user_id, **updatevalues):
        return await self.db.simple_update(
            table="users",
    ...
    async def _get_user_admin(self):
        ...
        admins = await self.db.runInteraction("_get_user_admin", _get_user_admin_txn)
        admins = [
