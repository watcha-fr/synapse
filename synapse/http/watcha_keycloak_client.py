...
class KeycloakClient(SimpleHttpClient):
    ...
    def __init__(self, hs):
        ...
        self.required_actions = hs.config.watcha.keycloak_required_actions  # watcha+
            ...
            user.update(
                {
                    ...
                    # watcha+
                    # Vide sur les instances dont les comptes proviennent d'une
                    # fédération d'identité : l'utilisateur n'a ni mot de passe
                    # ni profil à renseigner côté Keycloak.
